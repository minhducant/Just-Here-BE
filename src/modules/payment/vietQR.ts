export class VietQR {
  ...
  consumerAccountInformation: string;
  guid: string;
  serviceCode: string;
  ...
  setBeneficiaryOrganization(acquierID, consumerID) {
    ...
    const beneficiaryOrganizationLength: any = this.convertLength(
      `${acquier}${consumer}`.length,
    );

    const consumerAccountInformationLength: any = this.convertLength(
